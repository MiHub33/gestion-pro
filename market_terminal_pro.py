...
# --- MOTOR DE DATOS LIBRE DE BLOQUEOS ---
...
def descargar_datos_seguros(activo):
    try:
        ...
        if activo in ["BTC", "LINK"]:
            ...
            # API de Stooq limpia y en una sola línea para evitar errores de sintaxis
            ...
            df_d = df_raw[['Open', 'High', 'Low', 'Close']].astype(float).dropna()
